...
> **Версия для запуска и сдачи:** ветка `main`. В неё включена объединённая сборка `f5d7558`: данные и граф, скоринг и CLI, интерфейс расследования, дневная активность, полные цепочки и актуальный README. Команды ниже загружают `main`. AI-помощник проверяется отдельно в `codex/ai-assistant-test`; основной сценарий не требует его включения.
